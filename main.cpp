...
float totalCostMachiaj(const vector<Person>& persons)
{
    ...
    for (const Person& person : persons) {
        if(person.monster == "Vampir/Vampire")
        {
            monstru_vampir++;
        }
        else
            if(person.monster =="Varcolac/Werewolf")
        {
            monstru_varcolac++;
        }
        else
            if(person.monster == "Sirena/Mermaid")
        {
            monstru_sirena++;
        }
        else
            if(person.monster == "Clarvazator/Clairvoyant")
        {
            monstru_clarvazator++;
        }
        else
            if(person.monster == "Om/Human")
        {
            monstru_om++;
        }
    }
